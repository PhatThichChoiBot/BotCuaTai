...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`梁Admin Bot梁\n
👀 Tên: Nguyễn Văn Tài ( Kizz )
❎ Tuổi: 2xxx
👤 Giới tính: Nam
💫 Chiều cao cân nặng: 1m67 x 63kg
💘 Mối quan hệ: Độc thân
🌎 Quê quán: Nam Định ( 18 )
👫 Gu: Biết nấu cơm
🌸 Tính cách: Chả biết nữa =))
🌀 Sở thích: Chơi game, xem phim anime blabla, ăn, ngủ
💻Contact💻
☎ SĐT&Zalo:0866849625
🌐 Facebook: https://www.facebook.com/VanTaiOfficical
✉️ Email: Kizzvpbq@gmail.com`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://graph.facebook.com/${514219995}/picture?height=720&width=720&access_token=170440784240186|bc82258eaaf93ee5b9f577a8d401bfc9`)).pipe(
